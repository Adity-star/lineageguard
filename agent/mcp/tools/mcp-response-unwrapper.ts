...
export class MCPResponseUnwrapper {
   ...
   */
  static unwrapArray(rawResponse: any, toolName: string, arrayFieldName?: string): any[] {
    ...
    if (unwrapped && typeof unwrapped === "object") {
      ...
      const commonArrayFields = ["items", "results", "data", "entities", "fields", "queries"];
      ...
      if (unwrapped.total === 0 || unwrapped.count === 0 || (unwrapped.start === 0 && Object.keys(unwrapped).length <= 3)) {
        logger.debug(
          {
